    ...
    <div className="space-y-8 max-w-4xl animate-fade-in">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                disabled
                value={tenant?.name}
                className="mt-1 block w-full rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-sm text-slate-500 dark:text-slate-400"
              />
            </div>
            <div>
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Public URL Slug</label>
            <div className="mt-1 flex rounded-md shadow-sm">
              <span className="inline-flex items-center rounded-l-md border border-r-0 border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 text-slate-500 dark:text-slate-400 text-sm">
              ...
              <input
                ...
                disabled
                value={tenant?.slug}
                className="block w-full min-w-0 flex-1 rounded-none rounded-r-md border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-sm text-slate-500 dark:text-slate-400"
              />
            </div>
            <p className="mt-2 text-xs text-slate-400">Your unique identifier used for your public booking page.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="p-6">
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Define the general opening and closing hours for your venue. These act as the master constraints for all bookings.</p>
          <AvailabilityEditor 
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="p-6">
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">Customize how FluxBooking looks on your device.</p>
          <ThemeToggle />
        </div>
      </div>
